# NLP Sandbox contact Annotator Example

[![GitHub Release](https://img.shields.io/github/release/nlpsandbox/contact-annotator-example.svg?include_prereleases&color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/contact-annotator-example/releases)
[![GitHub CI](https://img.shields.io/github/workflow/status/nlpsandbox/contact-annotator-example/CI.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/contact-annotator-example/actions)
[![GitHub License](https://img.shields.io/github/license/nlpsandbox/contact-annotator-example.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/contact-annotator-example/blob/develop/LICENSE)
[![Docker Pulls](https://img.shields.io/docker/pulls/nlpsandbox/contact-annotator-example.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=pulls&logo=docker)](https://hub.docker.com/r/nlpsandbox/contact-annotator-example)
...
contact strings in a clinical note.
...
The command below starts the Contact Annotator locally.
...
We recommend using a Conda environment to install and run the Contact Annotator.

    conda create --name contact-annotator python=3.9.4
    conda activate contact-annotator

Install and start the Contact Annotator.
...
The Contact Annotator provides a web interface that you can use to annotate
clinical notes. The address of this interface depends on whether you run the
Contact Annotator using Docker (production mode) or the Python development
server.
...
This section describes how you can start developing your own Contact Annotator that
...
- If you develop in Java-Spring, create a new repository from the GitHub
  template [nlpsandbox/contact-annotator-example-java].

If you prefer to develop using another language or if you want to learn how this
repository has been generated, go to the section [Creating a new Contact Annotator
from scratch](#Creating-a-new-contact-Annotator-from-scratch).
...
### Creating a new Contact Annotator from scratch

Follow the steps listed below to generate an initial implementation - also
called "stub" - of the Contact Annotator using one of the many languages and
framework supported by [OpenAPITools/openapi-generator].

1. Download the latest OpenAPI specification of the [NLP Sandbox Contact Annotator].

       curl -fO https://nlpsandbox.github.io/nlpsandbox-schemas/contact-annotator/latest/openapi.yaml
...
Here is the protocol that we apply to update this example Contact Annotator when a
new release of the Contact Annotator specification is available:

1. Create a new branch

       git checkout -b upcontact-to-specification-x.y.z

2. Download the latest OpenAPI specification of the Contact Annotator.
...
- `Contact Annotator API version`: The version of the Contact Annotator specification
...
[NLP Sandbox Contact Annotator]: https://nlpsandbox.github.io/nlpsandbox-schemas/contact-annotator/latest/docs/
[nlpsandbox/contact-annotator-example]: https://hub.docker.com/r/nlpsandbox/contact-annotator-example
[GitHub template]: https://github.com/nlpsandbox/contact-annotator-example/generate
[NLP Sandbox]: nlpsandbox.io
[nlpsandbox/contact-annotator-example-java]: https://github.com/nlpsandbox/contact-annotator-example-java
[Apache License 2.0]: https://github.com/nlpsandbox/contact-annotator-example/blob/develop/LICENSE
