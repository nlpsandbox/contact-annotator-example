...
This repository provides an example implementation of the [NLP Sandbox Contact
Annotator API] written in Python-Flask. An NLP Sandbox contact annotator takes
as input a clinical note (text) and outputs a list of predicted contact
annotations found in the clinical note. Here dates are identified using regular
expressions.

This tool is provided to NLP developers who develop in Python as a starting
point to package their own contact annotator as an NLP Sandbox tool (see section
...
- Docker image: [docker.synapse.org/syn22277123/contact-annotator-example]
...
The command below starts this NLP Sandbox contact annotator locally.
...
```console
conda create --name contact-annotator python=3.9
conda activate contact-annotator
```

Install and start this NLP Sandbox contact annotator.
...
This section describes how to develop your own NLP Sandbox contact annotator in
...
[nlpsandbox/contact-annotator-example-java].
...
languages and frameworks. Here a contact annotator stub refers to an initial
implementation that has been automatically generated by [openapi-generator] from
the [NLP Sandbox Contact Annotator API] specification.
...
Generate the contact annotator stub from an empty GitHub repository (here in
Python-Flask):
...
npx @openapitools/openapi-generator-cli generate \
  -g python-flask \
  -o server \
  -i https://nlpsandbox.github.io/nlpsandbox-schemas/contact-annotator/latest/openapi.json
```

where the option `-i` refers to the OpenAPI specification of the [NLP Sandbox
Contact Annotator API].

The URL is composed of different elements:

- `contact-annotator` - The type of NLP Sandbox tool to generate. The list of
  all the NLP Sandbox tool types available is defined in the [NLP Sandbox
  schemas].
...
[docker.synapse.org/syn22277123/contact-annotator-example]: https://www.synapse.org/#!Synapse:syn25828638
[Synapse.org]: https://synapse.org
[openapi-generator]: https://github.com/OpenAPITools/openapi-generator
[contribution guide]: .github/CONTRIBUTING.md
[Apache License 2.0]: https://github.com/nlpsandbox/contact-annotator-example/blob/main/LICENSE
...
[NLP Sandbox Contact Annotator API]: https://nlpsandbox.github.io/nlpsandbox-schemas/contact-annotator/latest/docs/
[this GitHub template]: https://github.com/nlpsandbox/contact-annotator-example/generate
